                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <form action="{{ route('transaksi.simpan') }}" class="form-penjualan" method="post">
                            ...
                            <input type="text" name="id_member" id="id_member" value="{{ $memberSelected->id_member }}">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-btn">
                                            <button class="btn btn-info btn-flat" type="button"
                                                onclick="tampilMember()"><i class="fa fa-arrow-right"></i></button>
                                        </span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" name="kembali" id="kembali" class="form-control" value="0"
                                        readonly>
                                </div>
                            </div>
                        </form>
...
<script>
    ...
    function loadForm(diskon = 0, diterima = 0){
        ...
        .done(response => {
            ...
            if($('#diterima').val() !=0){
                $('.tampil-bayar').val('Kembali: Rp. '+ response.kembalirp);
                $('.tampil-terbilang').val(response.kembali_terbilang);
            }
        })
        .fail(errors => {
